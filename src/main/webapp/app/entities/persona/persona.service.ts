...
export class PersonaService {
     ...
     */
    private convertItemFromServer(json: any): Persona {
        const entity: Persona = Object.assign(new Persona(), json);
        entity.fechanacimiento = this.dateUtils
            .convertDateTimeFromServer(json.fechanacimiento);
        return entity;
    }
    ...
    private convert(persona: Persona): Persona {
        ...
        copy.fechanacimiento = this.dateUtils.toDate(persona.fechanacimiento);
        return copy;
    }
}

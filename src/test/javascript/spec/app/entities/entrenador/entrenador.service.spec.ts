...
describe('Service Tests', () => {
    ...
    describe('Entrenador Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EntrenadorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/entrenadors';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Entrenador', () => {

                let entity: Entrenador;
                service.find(123).subscribe((_entity: Entrenador) => {
                    entity = _entity;
                });
